...
export function Logo({ className, ...props }: React.ComponentProps<"svg">) {
  return (
    <svg className={cn(className)} {...props} width="281" height="281" viewBox="0 0 281 281" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_1167_5)">
      ...
      <defs>
        <clipPath id="clip0_1167_5">
          <rect width="280.84" height="280.84" fill="currentColor"/>
        </clipPath>
      </defs>
    </svg>
  )
