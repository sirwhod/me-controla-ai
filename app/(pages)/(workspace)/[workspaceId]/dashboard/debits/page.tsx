  ...
  return (
    <div className="flex w-full flex-col items-center justify-center space-y-8 p-4 h-96">
      <div className="flex flex-col items-center justify-center gap-2 p-4">
        ...
        <span className="text-muted-foreground text-sm">Carregando despesas...</span>
      </div>
    </div>
  )
}
      ...
      <div className="flex flex-1 flex-col gap-3.5 p-3 md:p-4 pt-3">
        <div className="bg-muted/40 min-h-[calc(100vh-5rem)] md:min-h-min flex-1 rounded-xl p-3 md:p-4 gap-3.5 flex flex-col">
          ...
          <div className="flex flex-col gap-2.5 md:hidden w-full">
            ...
            {/* Linha 2: Seletor de Mês/Ano + Botão Nova Despesa */}
          ...
          {/* 4. TABELA DE DADOS */}
          {isWorkspaceLoading || !workspaceActive || isDebitsLoading ? (
            <LoadPage />
          ) : (
