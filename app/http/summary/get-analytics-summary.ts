...
export interface AnalyticsSummary { totalExpenses: number; totalIncome: number; debitCount: number; creditCount: number; balance: number; cardTotals: Record<string, number> }
