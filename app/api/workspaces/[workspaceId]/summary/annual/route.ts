...
export async function GET(req: NextRequest, { params }: { params: Promise<{ workspaceId: string }> }) {
  try {
    ...
    console.error('Erro ao calcular resumo anual do workspace:', error)
    return NextResponse.json({ message: 'Erro interno do servidor ao calcular o resumo anual' }, { status: 500 })
  }
}
